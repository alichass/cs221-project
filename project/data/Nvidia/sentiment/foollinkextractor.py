...
def pulllinks(mainpage, filepath):
    ...
    driver.get(mainpage)
    count = 0
    print "Looping through https://www.fool.com/quote/nasdaq/nvidia/nvda/content"
    while count <9:
    ...
    print "Links Found"
    print "-------------------------"
    print "Writing " + str(len(links)) + " links to txt"

    with open(filepath, 'w') as f:
      for link in links:
          f.write(link + '\n')

mainpage = 'https://www.fool.com/quote/nasdaq/nvidia/nvda/content'
filepath = 'nvidiafoollinks.txt'
