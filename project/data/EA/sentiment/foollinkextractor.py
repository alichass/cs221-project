...
def pulllinks(mainpage, filepath):
    ...
    driver.get(mainpage)
    count = 0
    print "Looping through 'https://www.fool.com/quote/nasdaq/electronic-arts/ea/content'"
    while count <25:
...
mainpage = 'https://www.fool.com/quote/nasdaq/electronic-arts/ea/content'
filepath = 'eafoollinks.txt'
